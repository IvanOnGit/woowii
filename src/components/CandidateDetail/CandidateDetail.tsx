...
export default function CandidateDetail() {
    ...
    useEffect(() => {
        const fetchUserDetails = async (userId: string) => {
            try {
                const res = await fetch(`https://api.woowiihr.com/api/auth/get-user?userId=${userId}`);
        ...
        const fetchCandidateDetails = async () => {
            try {
                const response = await fetch(`https://api.woowiihr.com/api/auth/candidates/${candidateId}`);
    ...
    const handleAcceptCandidate = async () => {
        try {
            const res = await fetch(`https://api.woowiihr.com/api/auth/applications/${applicationId}/match`, {
                method: "PATCH",
                headers: {
            ...
            const userDetails = await fetch(`https://api.woowiihr.com/api/auth/get-user?userId=${candidateId}`);
            const userData = await userDetails.json();
        
            const companyId = localStorage.getItem("id");
            const companyDetails = await fetch(`https://api.woowiihr.com/api/auth/get-company?id=${companyId}`);
