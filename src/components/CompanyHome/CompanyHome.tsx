...
import { Container, ContainerWrapper, DropdownButton, DropdownContainer, DropdownItem, DropdownList, FirstMenuAsideItem, Header, HeaderItems, HelpButton, IdealTalent, MenuAside, SecondDropdownButton, SecondDropdownContainer, SecondDropdownItem, SecondDropdownList, SpanContainer, StepByStep, Steps, StyledLink, UserAndImageCombo } from "./styles";
